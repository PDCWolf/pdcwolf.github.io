...
for(var i = 0, k = 0, l = gdjs.New_32sceneCode.GDPlayerHitBoxObjects1.length;i<l;++i) {
    if ( gdjs.New_32sceneCode.GDPlayerHitBoxObjects1[i].getAutomatism("PlatformerObject").isJumping() ) {
...
{
for(var i = 0, k = 0, l = gdjs.New_32sceneCode.GDPlayerHitBoxObjects1.length;i<l;++i) {
    if ( gdjs.New_32sceneCode.GDPlayerHitBoxObjects1[i].getAutomatism("PlatformerObject").isFalling() ) {
        gdjs.New_32sceneCode.condition0IsTrue_0.val = true;
        gdjs.New_32sceneCode.GDPlayerHitBoxObjects1[k] = gdjs.New_32sceneCode.GDPlayerHitBoxObjects1[i];
        ++k;
    }
...
{
for(var i = 0, k = 0, l = gdjs.New_32sceneCode.GDPlayerHitBoxObjects1.length;i<l;++i) {
    if ( gdjs.New_32sceneCode.GDPlayerHitBoxObjects1[i].getAutomatism("PlatformerObject").isOnFloor() ) {
        gdjs.New_32sceneCode.condition0IsTrue_0.val = true;
        gdjs.New_32sceneCode.GDPlayerHitBoxObjects1[k] = gdjs.New_32sceneCode.GDPlayerHitBoxObjects1[i];
        ++k;
    }
...
for(var i = 0, k = 0, l = gdjs.New_32sceneCode.GDPlayerHitBoxObjects2.length;i<l;++i) {
    if ( !(gdjs.New_32sceneCode.GDPlayerHitBoxObjects2[i].getAutomatism("PlatformerObject").isMoving()) ) {
        gdjs.New_32sceneCode.condition0IsTrue_0.val = true;
...
{for(var i = 0, len = gdjs.New_32sceneCode.GDFlyObjects1.length ;i < len;++i) {
    gdjs.New_32sceneCode.GDFlyObjects1[i].activateAutomatism("PlatformerObject", false);
}
}}
...
{for(var i = 0, len = gdjs.New_32sceneCode.GDFlyObjects2.length ;i < len;++i) {
    ...
    gdjs.New_32sceneCode.GDSlimeWalkObjects2[i].getAutomatism("PlatformerObject").simulateLeftKey();
}
for(var i = 0, len = gdjs.New_32sceneCode.GDFlyObjects2.length ;i < len;++i) {
    gdjs.New_32sceneCode.GDFlyObjects2[i].getAutomatism("PlatformerObject").simulateLeftKey();
}
}{for(var i = 0, len = gdjs.New_32sceneCode.GDSlimeWalkObjects2.length ;i < len;++i) {
...
{for(var i = 0, len = gdjs.New_32sceneCode.GDFlyObjects2.length ;i < len;++i) {
    ...
    gdjs.New_32sceneCode.GDSlimeWalkObjects2[i].getAutomatism("PlatformerObject").simulateRightKey();
}
for(var i = 0, len = gdjs.New_32sceneCode.GDFlyObjects2.length ;i < len;++i) {
    gdjs.New_32sceneCode.GDFlyObjects2[i].getAutomatism("PlatformerObject").simulateRightKey();
}
}{for(var i = 0, len = gdjs.New_32sceneCode.GDSlimeWalkObjects2.length ;i < len;++i) {
...
for(var i = 0, k = 0, l = gdjs.New_32sceneCode.GDPlayerHitBoxObjects3.length;i<l;++i) {
    if ( gdjs.New_32sceneCode.GDPlayerHitBoxObjects3[i].getAutomatism("PlatformerObject").isFalling() ) {
        gdjs.New_32sceneCode.condition0IsTrue_0.val = true;
...
for(var i = 0, len = gdjs.New_32sceneCode.GDFlyObjects3.length ;i < len;++i) {
    ...
    gdjs.New_32sceneCode.GDSlimeWalkObjects3[i].activateAutomatism("PlatformerObject", true);
}
for(var i = 0, len = gdjs.New_32sceneCode.GDFlyObjects3.length ;i < len;++i) {
    gdjs.New_32sceneCode.GDFlyObjects3[i].activateAutomatism("PlatformerObject", true);
}
}{for(var i = 0, len = gdjs.New_32sceneCode.GDSlimeWalkObjects3.length ;i < len;++i) {
    gdjs.New_32sceneCode.GDSlimeWalkObjects3[i].getAutomatism("PlatformerObject").setGravity(1500);
}
for(var i = 0, len = gdjs.New_32sceneCode.GDFlyObjects3.length ;i < len;++i) {
    gdjs.New_32sceneCode.GDFlyObjects3[i].getAutomatism("PlatformerObject").setGravity(1500);
}
}{for(var i = 0, len = gdjs.New_32sceneCode.GDPlayerHitBoxObjects3.length ;i < len;++i) {
    gdjs.New_32sceneCode.GDPlayerHitBoxObjects3[i].getAutomatism("PlatformerObject").setCanJump();
}
}{for(var i = 0, len = gdjs.New_32sceneCode.GDPlayerHitBoxObjects3.length ;i < len;++i) {
    gdjs.New_32sceneCode.GDPlayerHitBoxObjects3[i].getAutomatism("PlatformerObject").simulateJumpKey();
}
}{gdjs.evtTools.sound.playSound(runtimeScene, "jump.wav", false, 100, 1);
}
{ //Subevents
...
{
for(var i = 0, k = 0, l = gdjs.New_32sceneCode.GDSlimeWalkObjects1.length;i<l;++i) {
    if ( gdjs.New_32sceneCode.GDSlimeWalkObjects1[i].getAutomatism("PlatformerObject").isOnFloor() ) {
...
gdjs.New_32sceneCode.GDSlimeWalkObjects1.length = k;for(var i = 0, k = 0, l = gdjs.New_32sceneCode.GDFlyObjects1.length;i<l;++i) {
    if ( gdjs.New_32sceneCode.GDFlyObjects1[i].getAutomatism("PlatformerObject").isOnFloor() ) {
        gdjs.New_32sceneCode.condition1IsTrue_0.val = true;
        gdjs.New_32sceneCode.GDFlyObjects1[k] = gdjs.New_32sceneCode.GDFlyObjects1[i];
        ++k;
    }
...
{
for(var i = 0, k = 0, l = gdjs.New_32sceneCode.GDSlimeWalkObjects1.length;i<l;++i) {
    if ( !(gdjs.New_32sceneCode.GDSlimeWalkObjects1[i].getAutomatism("PlatformerObject").isMoving()) ) {
...
gdjs.New_32sceneCode.GDSlimeWalkObjects1.length = k;for(var i = 0, k = 0, l = gdjs.New_32sceneCode.GDFlyObjects1.length;i<l;++i) {
    if ( !(gdjs.New_32sceneCode.GDFlyObjects1[i].getAutomatism("PlatformerObject").isMoving()) ) {
        gdjs.New_32sceneCode.condition2IsTrue_0.val = true;
        gdjs.New_32sceneCode.GDFlyObjects1[k] = gdjs.New_32sceneCode.GDFlyObjects1[i];
        ++k;
    }
...
{for(var i = 0, len = gdjs.New_32sceneCode.GDSlimeWalkObjects1.length ;i < len;++i) {
    gdjs.New_32sceneCode.GDSlimeWalkObjects1[i].activateAutomatism("PlatformerObject", false);
}
for(var i = 0, len = gdjs.New_32sceneCode.GDFlyObjects1.length ;i < len;++i) {
    gdjs.New_32sceneCode.GDFlyObjects1[i].activateAutomatism("PlatformerObject", false);
}
